...
a = Analysis(
    ...
    pathex=[str(src)],
    binaries=[],
    datas=[(_assets, 'assets'), (_completions, 'completions'), (_scripts, 'scripts'), *_sv_ttk_data, *_plaud_metadata],
    hiddenimports=[
        ...
        'win32cred',
        'pywintypes',
        # comtypes COM server used for toast click-activation (--com-activate path)
        'comtypes',
        'comtypes._comobject',
