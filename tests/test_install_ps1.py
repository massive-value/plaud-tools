...
#
# Moved here (from test_tray_env.py) during the CI/deps/test-suite audit —
# this is an install.ps1 behavioural test like the version-compare tests
# above, not a tray-environment test.
# ---------------------------------------------------------------------------
